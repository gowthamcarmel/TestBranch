...
function getPagesOfResults(search, startIndex, endIndex) {
    ...
    Log.d("retrieving up to " + numpages + " 1000-result pages");
...
EC.cloneSearchWithSortByInternalId = function (searchId) {
    ...
    // if any columns use a summary function don't clone
    if (_.any(cols, function(c) { return c.getSummary();})) {
        Log.d("skipping search cloning", "saved search has a summary field");
        return es;
    }
    else {
